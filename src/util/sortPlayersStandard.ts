 ...
 * @return A negative number if the position of `a` is earlier than that of `b`, zero if the positions of `a` and `b` are equal, or a positive number if the position of `a` is later than that of `b`.
 * @public
 */
