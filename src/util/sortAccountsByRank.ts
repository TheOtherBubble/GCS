 ...
 * @return A negative number if the tier and rank of `a` is lower than those of `b`, zero if the tiers and ranks of `a` and `b` are equal, or a positive number if the tier and rank of `a` is higher than those of `b`.
 * @public
 */
